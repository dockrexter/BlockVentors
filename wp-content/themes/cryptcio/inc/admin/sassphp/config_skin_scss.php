<?php 
$config = cryptcio_check_theme_options();
?>
...
$breadcrumb_font_family: <?php echo esc_attr($config['title-breadcrumbs-font']['font-family']) ?>;
$breadcrumb_font_size: <?php echo esc_attr($config['title-breadcrumbs-font']['font-size']) ?>;
$breadcrumb_font_color: <?php echo esc_attr($config['title-breadcrumbs-font']['color']) ?>;
