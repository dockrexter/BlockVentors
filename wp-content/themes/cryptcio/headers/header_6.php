...
<div class="header-wrapper <?php echo esc_attr($cryptcio_header_class);?>">
	<?php if(isset($cryptcio_settings['header6-topinfo']) && $cryptcio_settings['header6-topinfo']) :?>
		...
		<div class="<?php echo esc_attr($cryptcio_header_layout_class); ?>">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<nav class="menu-top header-container">
						<?php
							$before_items_wrap = '';
							$after_item_wrap = '';
							if(cryptcio_get_menu_top()!=''&& cryptcio_get_menu_top()!='default' && cryptcio_get_menu_top()!='1'){
								wp_nav_menu(array(
									'menu' => cryptcio_get_menu_top(),
				...
				<div class="col-lg-6 col-md-6 col-sm-6 hidden-xs">
					...
					<div class="header-social">
						<div class="social-icon display-flex">
							<ul>
								<?php if(isset($cryptcio_settings['social-header-twitter']) && $cryptcio_settings['social-header-twitter'] !=''):?>
								 <li><a href="<?php echo esc_url($cryptcio_settings['social-header-twitter']);?>" ><i class="fa fa-twitter"></i></a></li>
								<?php endif;?>
								<?php if(isset($cryptcio_settings['social-header-instagram']) && $cryptcio_settings['social-header-instagram'] !=''):?>
								 <li><a href="<?php echo esc_url($cryptcio_settings['social-header-instagram']);?>" ><i class="fa fa-instagram"></i></a></li>
								<?php endif;?>
								<?php if(isset($cryptcio_settings['social-header-facebook']) && $cryptcio_settings['social-header-facebook'] !=''):?>
								 <li><a href="<?php echo esc_url($cryptcio_settings['social-header-facebook']);?>" ><i class="fa fa-facebook"></i></a></li>
								<?php endif;?>
								<?php if(isset($cryptcio_settings['social-header-google']) && $cryptcio_settings['social-header-google'] !=''):?>
								 <li><a href="<?php echo esc_url($cryptcio_settings['social-header-google']);?>" ><i class="fa fa-google-plus"></i></i></a></li>
								<?php endif;?>
								<?php if(isset($cryptcio_settings['social-header-pinterest']) && $cryptcio_settings['social-header-pinterest'] !=''):?>
								 <li><a href="<?php echo esc_url($cryptcio_settings['social-header-pinterest']);?>" ><i class="fa fa-pinterest"></i></a></li>
								<?php endif;?>
							</ul>
						</div>
					</div>
					...
					<div class="header-container">
						...
						<div class="header-center">
							...
							<nav id="site-navigation" class="main-navigation">
								...
								?> 
								<?php if(isset($cryptcio_settings['header-social']) && $cryptcio_settings['header-social']):?>
									<div class="header-social social-mobile hidden-lg hidden-md hidden-sm">
						...
						<div class="header-right">
							<div class="header_icon display-inline-b">	          
								<?php 	                
									if (isset($cryptcio_settings['header6-search']) && $cryptcio_settings['header6-search']) {
							...
							<?php	 
								if (isset($cryptcio_settings['header6-minicart']) && $cryptcio_settings['header6-minicart'] && class_exists('WooCommerce')) :
