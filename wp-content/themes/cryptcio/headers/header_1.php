			...
			<div class="<?php echo esc_attr($cryptcio_header_layout_class); ?>">
				<div class="row">
					...
					<div class="col-md-4 col-sm-6 col-xs-12 text-right">
						...
						<?php endif; ?> 
						<?php	 
							if (isset($cryptcio_settings['header1-minicart']) && $cryptcio_settings['header1-minicart'] && class_exists('WooCommerce')) :
					...
					<div class="header-container text-right">
						...
						<div class="header-center">
							<h2 class="logo-mobile hidden-lg hidden-md">
								<a href="<?php echo esc_url(home_url('/')); ?>" rel="home">
									<?php 
									if(cryptcio_get_meta_value('logo_header_mobile')!=''){
										$logo_header =  cryptcio_get_meta_value('logo_header_mobile');				
									}
									else if(isset($cryptcio_settings['logo']) && $cryptcio_settings['logo']!=''){
										$logo_header = (cryptcio_get_meta_value('logo_header_page') != '') ? cryptcio_get_meta_value('logo_header_page') : $cryptcio_settings['logo']['url'];
									}
									?>
						...
						<div class="header-right">
							<div class="header_icon display-inline-b">	          
								<?php 	                
									if (isset($cryptcio_settings['header1-search']) && $cryptcio_settings['header1-search']) {
