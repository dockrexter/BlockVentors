             ...
             <?php if (have_posts()): ?>                        
                 <?php 
					if(get_post_type()=='project'){
                 		get_template_part( 'templates/content', 'project-archive' );
                 	}elseif(get_post_type()=='service'){
                 		get_template_part( 'templates/content', 'service-archive' );
                 	}elseif(get_post_type()=='events'){
                 		get_template_part( 'templates/content', 'events-archive' );
                 	}else{
