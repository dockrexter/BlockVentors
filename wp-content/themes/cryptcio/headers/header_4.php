...
$cryptcio_header_layout = isset($cryptcio_settings['header_layout_style']) ? $cryptcio_settings['header_layout_style'] :'';
...
<div class="header-wrapper <?php echo esc_attr($cryptcio_header_class);?>">
	<?php if(isset($cryptcio_settings['header-topinfo']) && $cryptcio_settings['header-topinfo']) :?>
			...
			<div class="<?php echo esc_attr($cryptcio_header_layout_class); ?>">
				<div class="row">
					...
					<div class="col-md-4 col-sm-6 col-xs-12 text-right">
						...
						<?php endif; ?> 
						<?php	 
							if (isset($cryptcio_settings['header4-minicart']) && $cryptcio_settings['header4-minicart'] && class_exists('WooCommerce')) :
							$cryptcio_minicart_template = cryptcio_get_minicart_template();?>
							<div  class="mini-cart display-inline-b"> <?php echo wp_kses($cryptcio_minicart_template, cryptcio_allow_html()); ?> </div>
						<?php endif; ?> 
	...
	<div class="header-middle">
		<div class="<?php echo esc_attr($cryptcio_header_layout_class); ?>">
			<div class="row">
				<div class="col-lg-4 col-md-4 hidden-sm hidden-xs text-right">
					<div class="header-container">
						<div class="header-center">
							<h5 class="hidden-lg hidden-md"><?php echo esc_html__('Menu','cryptcio');?></h5>
							<nav class="main-navigation menu-left">
								<?php
									$before_items_wrap = '';
									$after_item_wrap = '';
									if(cryptcio_get_menu_left_id()!=''&& cryptcio_get_menu_left_id()!='default' && cryptcio_get_menu_left_id()!='1'){
										wp_nav_menu(array(
											'menu' => cryptcio_get_menu_left_id(),
				...
				<div class="col-lg-4 col-md-4 hidden-sm hidden-xs f-float">
					<div class="header-container">
						<div class="header-center">
							<nav class="main-navigation menu-right">
								<?php
									$before_items_wrap = '';
									$after_item_wrap = '';
									if(cryptcio_get_menu_right_id()!=''&& cryptcio_get_menu_right_id()!='default' && cryptcio_get_menu_right_id()!='1'){
										wp_nav_menu(array(
											'menu' => cryptcio_get_menu_right_id(),
											'menu_class' => 'mega-menu',
											'items_wrap' => $before_items_wrap . '<ul id="%1$s" class="%2$s">%3$s</ul>' . $after_item_wrap,
											'walker' => new Cryptcio_Primary_Walker_Nav_Menu()
												)
						...
						<div class="header-right">
							<div class="header_icon display-inline-b">	          
								<?php 	                
									if (isset($cryptcio_settings['header4-search']) && $cryptcio_settings['header4-search']) {
				...
				<div class="hidden-lg hidden-md col-sm-12 col-xs-12">
					<div class="header-container text-right">
							...
							<nav id="site-navigation" class="main-navigation">
								<?php
									...
									if(cryptcio_get_menu_right_id()!=''&& cryptcio_get_menu_right_id()!='default' && cryptcio_get_menu_right_id()!='1'){
										wp_nav_menu(array(
											'menu' => cryptcio_get_menu_right_id(),
											'menu_class' => 'mega-menu menu-bottom',
											'items_wrap' => $before_items_wrap . '<ul id="%1$s" class="%2$s">%3$s</ul>' . $after_item_wrap,
											'walker' => new Cryptcio_Primary_Walker_Nav_Menu()
												)
										);                    
						...
						<div class="header-right">
							<div class="header_icon display-inline-b">	          
								<?php 	                
									if (isset($cryptcio_settings['header2-search']) && $cryptcio_settings['header2-search']) {
										$cryptcio_search_template = cryptcio_get_search_form();
										echo '<div class="search-block-top display-flex">' .wp_kses($cryptcio_search_template, cryptcio_allow_html()) . '</div>';
									}  
								?>  
							...
							<?php	 
								if (isset($cryptcio_settings['header2-minicart']) && $cryptcio_settings['header2-minicart'] && class_exists('WooCommerce')) :
								$cryptcio_minicart_template = cryptcio_get_minicart_template();?>
