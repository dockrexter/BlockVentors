			...
			<div class="<?php echo esc_attr($cryptcio_header_layout_class); ?>">
				<div class="row">
					...
					<div class="col-md-4 col-sm-6 col-xs-12 text-right">
						...
						<?php endif; ?> 
						<?php	 
							if (isset($cryptcio_settings['header3-minicart']) && $cryptcio_settings['header3-minicart'] && class_exists('WooCommerce')) :
					...
					<?php if (is_front_page()) : ?>
						...
						<?php else : ?>
							...
							<a href="<?php echo esc_url(home_url('/')); ?>" rel="home">
								...
								if(isset($cryptcio_settings['logo3-fixed']) && $cryptcio_settings['logo-fixed']!=''){
									$logo_header_sticky = (cryptcio_get_meta_value('logo_header_fixed_page') != '') ? cryptcio_get_meta_value('logo_header_fixed_page') : $cryptcio_settings['logo3-fixed']['url'];
								}
								?>
					...
					<div class="header-container text-right">
						...
						<div class="header-right">
							<div class="header_icon display-inline-b">	          
								<?php 	                
									if (isset($cryptcio_settings['header3-search']) && $cryptcio_settings['header3-search']) {
