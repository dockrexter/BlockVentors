(function ($) {
    ...
    jQuery(document).ready(function($) {
            // color field
            $('.cryptcio-meta-color').each(function() {
                var $el = $(this),
                    $c = $el.find('.cryptcio-color-field'),
                    $t = $el.find('.cryptcio-color-transparency');
    ...
    $('#redux-header').remove();
    $('<div class="redux-header"><div class="display_header"><h2>Cryptcio Options</h2><span>'+cryptcio_params.cryptcio_version+'</span></div><div class="clear"></div></div>').insertBefore('.redux-container .redux-sidebar');
})(jQuery);
