...
<div class="ocdi  wrap  about-wrap">
	...
	<div class="ocdi__intro-text">
		...
		<!-- ARROWPRESS IMPORTER ADDED -->
		<hr>

		<p><strong><?php esc_html_e( 'IMPORT DEMO STEPS: ', 'pt-ocdi' ); ?></strong></p>

		<ol>
			<li><?php echo  __( 'Click <b> Import </b>  button to import <b>Base Content</b>.', 'pt-ocdi' ); ?>
				<p><?php esc_html_e( 'NOTE: This is required step when you start to import demo content initially. You should import base content only one time if base content successfully imported ', 'pt-ocdi' ); ?></p>
			</li>
			<li><?php _e( 'After successfully importing Base Content, you can go to <b>Appearance > Import demo</b> and import <strong>Home Demo </strong> you want. ', 'pt-ocdi' ); ?></li>
		</ol>
