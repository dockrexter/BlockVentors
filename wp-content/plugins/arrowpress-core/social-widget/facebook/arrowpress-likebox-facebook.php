...
class arrowpress_facebook_likebox extends WP_Widget {
	private static $id_of_like_box=0;
	// Constructor //	
	function __construct() {	
		parent::__construct(
                'arrowpress_facebook_likebox', // Base ID
                __('Arrowpress Facebook Like Box', 'arrowpress-core'), // Name
                array('description' => __('This Widget show the Facebook', 'arrowpress-core'),) // Args
        ); // Create the widget
	...
	public function generete_facbook_widget_page($params){
		...
		$facbook_front.='<div style="font-size:2px;width:2px;height:1px;overflow: hidden;"><a href="https://wordpress.org/plugins/contact-forms-builder">WordPress Contact form</a></div>';
